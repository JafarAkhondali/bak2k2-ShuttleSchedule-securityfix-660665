...
config(['$routeProvider', function ($routeProvider) {
    ...
    $routeProvider.when('/routes', {templateUrl: 'partials/route-list.html', controller: 'RouteListCtrl'});
    $routeProvider.when('/routes/:routeId', {templateUrl: 'partials/route-detail.html', controller: 'RouteDetailCtrl'});
